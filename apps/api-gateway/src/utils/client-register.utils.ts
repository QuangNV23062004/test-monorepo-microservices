...
export const MICROSERVICE_CLIENTS = {
  AUTH_SERVICE: process.env.AUTH_SERVICE_NAME || 'AUTH_SERVICE',
  USER_SERVICE: process.env.USER_SERVICE_NAME || 'USER_SERVICE',
  PAYMENT_SERVICE: process.env.PAYMENT_SERVICE_NAME || 'PAYMENT_SERVICE',
...
export const MicroserviceClients: ClientsModuleOptions = [
  getClient(
    ...
    Number(process.env.AUTH_SERVICE_TRANSPORT) || Transport.TCP, //Transport.TCP = 0
  ...
  getClient(
    ...
    Number(process.env.PAYMENT_SERVICE_TRANSPORT) || Transport.TCP,
    process.env.PAYMENT_SERVICE_HOST || 'localhost',
    Number(process.env.PAYMENT_SERVICE_PORT) || 3003
  ),
  getClient(
